...
class Barcode extends Component {
  barcode = () => {
    ...
    function processImage() {
      ...
      var imgd = elements.ctx.getImageData(
        dimensions.start,
    ...
    function drawBars(binary) {
      for (var i = 0, ii = binary.length; i < ii; i++) {
        ...
        elements.ctxg.lineWidth = 3;
        elements.ctxg.beginPath();
        elements.ctxg.moveTo(dimensions.start + i, dimensions.height * 0.5);
        elements.ctxg.lineTo(dimensions.start + i + 1, dimensions.height * 0.5);
        elements.ctxg.stroke();
      }
    }
  };
  ...
  render() {
    return (
      <div>
        ...
        <div id="result" />
        <button onClick={this.barcode}>Click></button>
      </div>
    );
  }
}
